...
from . import paths
from . import chat_history as ch
...
class MainWindow(QMainWindow):
    ...
    def _init_ai_page(self):
        ...
        self.btn_jd_analysis.setFixedHeight(28)
        ...
        self.btn_gen_resume.setFixedHeight(28)
        ...
        self.btn_rewrite.setFixedHeight(28)
        ...
        self.btn_match.setFixedHeight(28)
        ...
        self.btn_self_intro.setFixedHeight(28)
        ...
        btn_ctx_refresh.setFixedHeight(28)
        ...
        btn_ctx_clear.setFixedHeight(28)
        ...
        self.btn_cli_init.setFixedHeight(28)
        ...
        self.btn_cli_upgrade.setFixedHeight(28)
        ...
        self.btn_cli_help.setFixedHeight(28)
        ...
        btn_refresh_models.setFixedHeight(28)
        ...
        btn_refresh_bal = QPushButton("🔄")
        btn_refresh_bal.setFixedSize(28, 28)
    ...
    def _on_ai_biz(self, action):
        ...
        if channel == "reasonix":
            ...
            if not model_id:
                ...
                return
            if not api_key:
                QMessageBox.information(self, "?? API Key", "???? API Key?")
                return
        ...
        if action == "jd_analysis":
            if not jd_text:
                QMessageBox.information(self, "??", "????? JD ???????? JD?")
                return
            ...
            if not titles:
                ...
                return
            item, ok = QInputDialog.getItem(self, "????", "?????????", titles, 0, False)
            if not ok:
                return
        ...
        self.statusBar().showMessage("???????????? Ctrl+Enter ??", 5000)
